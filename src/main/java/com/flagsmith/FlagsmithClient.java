...
public class FlagsmithClient {
  ...
  public static class Builder {
     ...
     * default. If you would like to override this default behaviour, you can use this method.
     *
    ...
    /**
     * Enable in-memory caching for the Flagsmith API. If no other cache configuration is set, the
     * Caffeine defaults will be used, i.e. no limit
     *
